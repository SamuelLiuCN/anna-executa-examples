...
`document-extractor-v0.1.6`. Each archive contains a `manifest.json` and
...
anna-app apps cut 0.1.6 --changelog "Add report completeness checks, retries, and rerun support"
```
