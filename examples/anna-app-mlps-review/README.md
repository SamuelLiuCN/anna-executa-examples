...
`document-extractor-v0.1.5`. Each archive contains a `manifest.json` and
...
anna-app apps cut 0.1.5 --changelog "Improve local extractor resolution and OCR diagnostics"
```
